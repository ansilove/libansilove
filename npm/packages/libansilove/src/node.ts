...
export async function loadNode(options: LoadOptions = {}): Promise<LibansiloveBindings> {
	const factoryModule: { default: ModuleFactory } = await import("./wasm/libansilove.node.mjs");
